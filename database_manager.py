...
df.to_sql(table_name, conn, if_exists = 'replace', index = False) # Saves the 'df' DataFrame to a database table, replacing it if it already exists, and omits the DataFrame index from the table.
...
# Query 2: Display only the DEP_NAME column for the full table.
